...
if(cannextc != 0 && cannextme != 0){if(me == 2){me=1;tipTip.innerHTML = '当前轮到：黑棋';}else{me=2;tipTip.innerHTML = '当前轮到：白棋';setTimeout('comPuter()', 1800 );}}
else if(cannextme != 0){me = 1; tipTip.innerHTML = '当前轮到：黑棋';}
else if(cannextc != 0){me=2;tipTip.innerHTML = '当前轮到：白棋';setTimeout('comPuter()', 2800 );}
else{me=3}
